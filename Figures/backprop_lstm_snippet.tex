%% ──────────────────────────────────────────────────────────
%% Animated Backpropagation Figure (LSTM)
...
\begin{figure}[htbp]
    ...
    \animategraphics[
        ...
        controls,
        width=0.95\textwidth
    ]{10}{Figures/backprop_frames/lstm_}{0000}{0149}
    \caption{Animated backpropagation through the LSTM architecture.
