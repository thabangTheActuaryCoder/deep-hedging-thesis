...
The martingale/markovian approach to optimal stopping levels dynamic programming and backward induction. `in discrete time, one can compute the Snell envelope by backward recursion: $Y_T = \xi_T$ at maturiry.
